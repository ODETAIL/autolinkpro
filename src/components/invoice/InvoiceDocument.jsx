      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <Text style={styles.title}>
            Invoice #{String(invoiceData?.invoiceId).padStart(6, "0")}
          </Text>
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <View>
              ...
              <Text>
                PDF created{" "}
                {invoiceData?.timeStamp?.toDate().toLocaleDateString()}
              </Text>
              <Text>${grandTotal.toFixed(2)}</Text>
            </View>
            <View>
              <Text style={styles.label}>Payment:</Text>
              <Text>{invoiceData?.payment || "Due on Receipt"}</Text>
            </View>
          </View>
          <View style={styles.divider} />
        </View>
              ...
              <View key={index} style={styles.tableRow}>
                <View style={styles.itemColumn}>
                  <Text style={styles.item}>
                    ...
                    {replacementEligibleServices.includes(item.name)
                      ? "replacement"
                      : ""}
                  </Text>
      ...
      <Page size="A4" style={styles.disclaimerPage}>
        <View>
          ...
          <Text style={styles.disclaimerText}>
            ...
            the windshield may crack during or after the process.{" "}
            {selectedCompany === "odetail" ? "O Detail" : "Aztec"} is not
